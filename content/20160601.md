...
class Spur(object):
    ...
    def Gear(self, midx, midy, rp, n=20, pa=20, color="blue"):
        # 齒輪漸開線分成 15 線段繪製
        imax = 15
...
ctx.translate(-x_g1, -y_g1)
# 繪製第一個齒輪輪廓
Spur(ctx).Gear(x_g1, y_g1, rp_g1, n_g1, pa, "yellow")
ctx.restore()
...
# put it back
ctx.translate(-x_g5, -y_g5)
Spur(ctx).Gear(x_g5, y_g5, rp_g5, n_g5, pa, "pink")
ctx.restore()
...
# put it back
ctx.translate(-x_g6, -y_g6)
Spur(ctx).Gear(x_g6, y_g6, rp_g6, n_g6, pa, "gray")
ctx.restore()
