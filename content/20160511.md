...
<p><input id="n1" value="11"></input><br />
<input id="n2" value="23"></input><br />
<input id="n3" value="15"></input><br />
...
def setgearnumber(e):
    ...
    if doc["n1"].value.isdigit():
        n11 = int(doc["n1"].value)
    else:
        n11 = 11

    if doc["n2"].value.isdigit():
        n23 = int(doc["n2"].value)
    else:
        n23 = 23

    if doc["n3"].value.isdigit():
        n15 = int(doc["n3"].value)
    else:
        n15 = 15

    # 只使用畫布高度的 80%
    canvas_size = canvas.height*0.4
    r11 = canvas_size*n11/(n11+n23+n15)
    r23 = canvas_size*n23/(n11+n23+n15)
    r15 = canvas_size*n15/(n11+n23+n15)
    # 計算各齒輪中心座標
    x11 = x - r11-r23
    y11 = y
    ...
    ctx.save()
    ctx.translate(x23, y23)
    # 中間齒輪轉動 -90 度加上一齒, 可以與左側齒輪囓合
    ctx.rotate(-90*deg-math.pi/n23)
    ctx.translate(-x23, -y23)
    gear23 = Spur(ctx).Gear(x23, y23, r23, n23, pa, "yellow")
    ctx.restore()
    ...
    ctx.rotate(-90*deg-math.pi/n15+(180*deg+math.pi/n23)*n23/n15)
    ctx.translate(-x15, -y15)
    gear15 = Spur(ctx).Gear(x15, y15, r15, n15, pa, "gray")
    ctx.restore()
...
form = html.FORM()
input1 = html.INPUT(type="text", id="n1", name="n1", value="11")
input2 = html.INPUT(type="text", id="n2", name="n2", value="23")
input3 = html.INPUT(type="text", id="n3", name="n3", value="15")
